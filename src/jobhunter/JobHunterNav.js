      ...
      <li><button className="logoutButton" onClick={handleLogout}>Logout</button></li>
        ...
        <Routes>
          <Route path='/jobhunterhome' Component={JobHunterHome}></Route>
           ...
           <Route path='/jobhunterprofile' Component={JobHunterProfile}></Route>
           <Route path="/updatejobseekerprofile" element={<UpdateJobHunterProfile/>} exact />
